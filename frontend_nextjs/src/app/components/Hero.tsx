        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center min-h-[400px] md:min-h-[600px]">
          ...
          <div className="space-y-6 md:space-y-8">
            <div className="space-y-4 md:space-y-6 mb-6 md:mb-10">
              ...
              <button className="h-12 md:h-14 w-full md:w-68 text-sm md:text-base rounded-lg bg-gradient-to-br from-[#4C545A] to-[#060E14] text-[#F8F7F4] flex items-center font-semibold justify-center transition-all duration-200 hover:scale-103 shadow-lg cursor-pointer">
                Launch Dapp
              </button>
            </div>
