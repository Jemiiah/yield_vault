    ...
    <>
      ...
      <section className="relative z-10 md:mx-12 mx-4 px-4 md:px-6 py-12 md:py-16 mb-12 md:mb-20">
        ...
        <div className="flex justify-center mt-8 md:mt-12">
          <Link
            to="/dashboard"
            className="h-10 md:h-12 w-full md:w-52 text-sm md:text-base rounded-lg bg-gradient-to-br from-[#4C545A] to-[#060E14] dark:bg-gradient-to-br dark:from-[#DAD9D9E5] dark:to-[#F8F7F4] dark:text-[#1A2228] backdrop-blur-md text-[#F8F7F4] flex items-center font-semibold justify-center transition-all duration-200 hover:scale-105 shadow-lg cursor-pointer"
          >
            Launch Dapp
          </Link>
        </div>
